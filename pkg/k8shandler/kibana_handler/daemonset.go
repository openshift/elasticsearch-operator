...
func (clusterRequest *ClusterKibanaRequest) GetDaemonSetList(selector map[string]string) (*apps.DaemonSetList, error) {
...
func (clusterRequest *ClusterKibanaRequest) RemoveDaemonset(daemonsetName string) error {
