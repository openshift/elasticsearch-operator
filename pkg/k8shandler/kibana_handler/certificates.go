...
func (clusterRequest *ClusterKibanaRequest) extractSecretToFile(secretName string, key string, toFile string) (err error) {
...
func (clusterRequest *ClusterKibanaRequest) writeSecret() (err error) {
...
func (clusterRequest *ClusterKibanaRequest) readSecrets() (err error) {
...
func (clusterRequest *ClusterKibanaRequest) extractCertificates(secretName string, certs map[string]string) (err error) {
...
func (clusterRequest *ClusterKibanaRequest) CreateOrUpdateCertificates() (err error) {
