...
func (clusterRequest *ClusterKibanaRequest) CreateOrUpdateServiceAccount(name string, annotations *map[string]string) error {
...
func (clusterRequest *ClusterKibanaRequest) RemoveServiceAccount(serviceAccountName string) error {
