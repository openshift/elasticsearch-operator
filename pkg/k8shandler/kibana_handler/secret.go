...
func (clusterRequest *ClusterKibanaRequest) CreateOrUpdateSecret(secret *core.Secret) (err error) {
...
func (clusterRequest *ClusterKibanaRequest) GetSecret(secretName string) (*core.Secret, error) {
	secret := &core.Secret{}
...
func (clusterRequest *ClusterKibanaRequest) RemoveSecret(secretName string) error {
