...
func (clusterRequest *ClusterKibanaRequest) GetCronJobList(selector map[string]string) (*batch.CronJobList, error) {
...
func (clusterRequest *ClusterKibanaRequest) RemoveCronJob(cronjobName string) error {
