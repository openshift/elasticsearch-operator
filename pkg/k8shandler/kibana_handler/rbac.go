...
func (clusterRequest *ClusterKibanaRequest) CreateClusterRole(name string, rules []rbac.PolicyRule) (*rbac.ClusterRole, error) {
...
func (clusterRequest *ClusterKibanaRequest) RemoveClusterRoleBinding(name string) error {
