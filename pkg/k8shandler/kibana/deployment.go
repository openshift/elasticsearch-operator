...
func (clusterRequest *ClusterKibanaRequest) GetDeploymentList(selector map[string]string) (*apps.DeploymentList, error) {
...
func (clusterRequest *ClusterKibanaRequest) RemoveDeployment(deploymentName string) error {
...
func (clusterRequest *ClusterKibanaRequest) GetReplicaSetList(selector map[string]string) (*apps.ReplicaSetList, error) {
