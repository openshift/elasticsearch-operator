...
func (clusterRequest *ClusterKibanaRequest) getKibanaStatus() ([]kibana.KibanaStatus, error) {

	status := []kibana.KibanaStatus{}
...
func (clusterRequest *ClusterKibanaRequest) getPodConditions(component string) (map[string][]kibana.ClusterCondition, error) {
