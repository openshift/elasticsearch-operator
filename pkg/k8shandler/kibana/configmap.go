...
func (clusterRequest *ClusterKibanaRequest) CreateOrUpdateTrustedCaBundleConfigMap(configMap *core.ConfigMap) error {
	return clusterRequest.createOrUpdateConfigMap(configMap, false)
}

func (clusterRequest *ClusterKibanaRequest) CreateOrUpdateConfigMap(configMap *core.ConfigMap) error {
	return clusterRequest.createOrUpdateConfigMap(configMap, true)
}

func (clusterRequest *ClusterKibanaRequest) createOrUpdateConfigMap(configMap *core.ConfigMap, checkData bool) error {
...
func (clusterRequest *ClusterKibanaRequest) RemoveConfigMap(configmapName string) error {
