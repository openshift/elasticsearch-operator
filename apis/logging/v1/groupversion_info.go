...
// TODO: created role.yaml, but not used. ./bundle/manifests takes effective.
...
// +kubebuilder:rbac:groups=core,resources=pods;pods/exec;services;endpoints;persistentvolumeclaims;events;configmaps;secrets;serviceaccounts,verbs=*
