...
IMAGE_CURATOR5=${IMAGE_CURATOR5:-quay.io/openshift-logging/curator5:5.8.1}
...
sed -i "s,quay.io/openshift-logging/curator5:5.8.1,${IMAGE_CURATOR5}," /manifests/*clusterserviceversion.yaml
