...
ELASTICSEARCH_OPERATOR_NAMESPACE=${TEST_NAMESPACE} ${repo_dir}/olm_deploy/scripts/catalog-deploy.sh
# install the elasticsearch operator from that catalog
ELASTICSEARCH_OPERATOR_NAMESPACE=${TEST_NAMESPACE} ${repo_dir}/olm_deploy/scripts/operator-install.sh
